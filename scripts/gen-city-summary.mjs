...
lines.push("");
lines.push("Ground rules the world enforces on itself: roads may not exceed a 0.13 slope, buildings 0.32; nothing is built on beach, cliff or water. A point's plot, block, district and settlement can be looked up from its coordinates.");
