  ...
  async query(queryVector, options = {}) {
    ...
    for (const [id, item] of this.vectors.entries()) {
      ...
      matches.push({
        id,
        score,
        metadata: options.returnMetadata ? item.metadata : void 0
      });
    }
...
var SEMANTIC_CLUSTERS = [
  ...
  { words: ["neoclassical", "neoclassic", "mansion", "portico", "columns", "estate", "grand", "pillars"], dims: [82, 83, 84, 85], weight: 3 },
  { words: ["cantilever", "cantilevered", "floating", "cube", "boxes", "penthouse", "helipad", "helicopter", "landing"], dims: [86, 87, 88, 89, 90], weight: 3 },
  { words: ["origami", "folded", "geometric", "sculptural", "cultural", "museum", "gallery", "crystalline", "pavilion"], dims: [91, 92, 93, 94], weight: 3 },
  { words: ["diagrid", "exoskeleton", "diamond", "lattice", "structural", "steel"], dims: [95, 96, 97, 98], weight: 3 },
  ...
  { words: ["townhouse", "brownstone", "rowhouse", "row", "brick", "urban"], dims: [125, 126, 127, 128], weight: 3 },
  { words: ["apartment", "flat", "walkup", "studios", "studio", "micro", "occupant", "compact", "density"], dims: [129, 130, 131, 132, 133], weight: 3 },
  { words: ["container", "shipping", "cargo", "freight", "modular", "prefab", "prefabricated", "habitat"], dims: [134, 135, 136, 137, 138], weight: 3 },
  { words: ["timber", "mass", "block"], dims: [139, 140, 141], weight: 2.8 },
  { words: ["bodega", "corner", "grocery", "convenience", "storefront", "shop", "retail", "store"], dims: [142, 143, 144, 145, 146], weight: 3 },
...
function entryFitsSpace(entry, fits) {
  ...
  if (entry.foot && fits.w <= 16 && fits.d <= 16) {
    if (entry.foot.w <= fits.w && entry.foot.d <= fits.d || entry.foot.w <= fits.d && entry.foot.d <= fits.w) {
      return true;
    }
    return false;
  }
